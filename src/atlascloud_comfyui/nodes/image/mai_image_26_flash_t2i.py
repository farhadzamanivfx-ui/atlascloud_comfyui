...
class AtlasMAIImage26FlashTextToImage:
    ...
    def run(
        ...
        if not prompt:
            raise RuntimeError("prompt is required for MAI-Image-2.6-Flash Text-to-Image")

        client = atlas_client.client

        payload: Dict[str, Any] = {
            "model": "microsoft/mai-image-2.6-flash/text-to-image",
            "prompt": prompt,
