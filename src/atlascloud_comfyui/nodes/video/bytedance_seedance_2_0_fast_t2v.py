...
class AtlasSeedance20FastTextToVideo:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "resolution": (["480p", "720p", "720p-SR", "1080p-SR", "1440p-SR"], {"default": "720p", "tooltip": "Resolution. Fast tier: native 480p/720p; SR tiers (720p-SR/1080p-SR/1440p-SR) render lower then FlashVSR-upscale. No native 1080p/4k on Fast."}),
    ...
    async def run(
        ...
        return await loop.run_in_executor(
            ...
            int(duration), resolution, ratio, bitrate_mode,
