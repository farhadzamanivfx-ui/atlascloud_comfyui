    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "resolution": (["480p", "720p", "720p-SR", "1080p", "1080p-SR", "1440p-SR", "4k"], {"default": "720p", "tooltip": "Resolution. SR tiers render at 720p then FlashVSR-upscale (1080p-SR/1440p-SR). 4k = native UHD 3840×2160, 16:9 only, full model only, H.265/10-bit."}),
