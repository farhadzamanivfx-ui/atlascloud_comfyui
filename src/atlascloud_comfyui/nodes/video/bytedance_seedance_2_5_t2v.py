    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "resolution": (["480p", "720p", "720p-sr", "720p-esr", "1080p", "1080p-sr", "1080p-esr", "1080p-esr & 60fps", "1440p-sr", "1440p-esr", "4k-esr"], {"default": "720p", "tooltip": "Resolution. -sr / -esr tiers render then upscale (esr = enhanced); 4k-esr is the top tier"}),
