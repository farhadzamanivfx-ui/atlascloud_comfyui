...
class AtlasKlingV30ProTextToVideo:
...
NODE_CLASS_MAPPINGS = {"AtlasCloud Kling V3.0 Pro Text-to-Video": AtlasKlingV30ProTextToVideo}
NODE_DISPLAY_NAME_MAPPINGS = {"AtlasCloud Kling V3.0 Pro Text-to-Video": "AtlasCloud Kling V3.0 Pro Text-to-Video"}
