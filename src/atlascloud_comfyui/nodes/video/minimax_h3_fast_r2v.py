...
class AtlasMinimaxH3FastReferenceToVideo:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "resolution": (["480P"], {"default": "480P", "tooltip": "Output resolution"}),
    ...
    def run(
        ...
        if not urls:
            raise RuntimeError(
                "refers is required for MiniMax H3 Fast Reference-to-Video (at least one image or video URL)"
            )
        ...
        payload: Dict[str, Any] = {
            "model": "minimax/h3-fast/reference-to-video",
